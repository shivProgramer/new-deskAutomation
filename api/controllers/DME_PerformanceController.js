...
const createPerformance = async (req, res) => {
    try {
      ...
      res.status(201).json({ message: 'Performance entry created successfully' });
    } catch (error) {
      console.error(error);
...
const getAllPerformance = async (req, res) => {
  try {
    const performanceData = await DME_Performance.findAll();
...
const updatePerformance = async (req, res) => {
    try {
      ...
      res.status(200).json({ message: 'Performance entry updated successfully' });
    } catch (error) {
      console.error(error);
