...
// // Get a list of all projects with summary data
...
//       where: { user_id: id },
//       include: [
//         { model: AdminUser, as: "adminUser", attributes: ["user_id", "username"] },
//       ], // Include admin user info if needed
//     });
...
//     if (user_id !== undefined) project.user_id = user_id;

//     // // Set the updated_at field to the current timestamp
//     // project.updated_at = new Date();  // This automatically formats the date in a valid format for Sequelize/SQL
